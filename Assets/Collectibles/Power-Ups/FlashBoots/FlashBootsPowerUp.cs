...
public class FlashBootsPowerUp : MonoBehaviour
{
    ...
    private string pickupTitle = "Barely Allen";
    private string pickupText = "+10% Movement Speed";
